    ...
    <footer className="bg-[#0e0e0e] border-t border-white/5">
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 py-20">
        <div className="flex flex-col md:flex-row justify-between items-start gap-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <p className="text-[10px] uppercase tracking-[0.2em] text-on-surface/40 max-w-xs">
              {BUSINESS_INFO.tagline}
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 rounded-full border border-outline-variant/30 flex items-center justify-center text-on-surface/50 hover:bg-primary hover:text-on-primary hover:border-primary transition-all"
                aria-label="Share"
              >
      ...
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12">
        <div className="border-t border-white/5 py-10 text-center">
          <p className="text-on-surface/30 text-[10px] tracking-[0.4em] uppercase">
